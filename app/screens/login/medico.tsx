...
const MedicoLoginScreen = () => {
  ...
  useFocusEffect(
    useCallback(() => {
      ...
      StatusBar.setBackgroundColor("#3C497A");
    ...
    >
      ...
      <TouchableOpacity
        ...
        >
          ...
          />
          <Text style={[styles.title, keyboardVisible ? {display:'none'}: {},]}>Profesional</Text>
        </View>
      </View>
...
export default MedicoLoginScreen;
